...
class SmashGui(QMainWindow):
	...
	def initializePlayerSelection(self):
		...
		self.playerOneSelection.resize(100,20)
		...
		self.playerTwoSelection.resize(100,20)
		...
		self.playerThreeSelection.resize(100,20)
		...
		self.playerFourSelection.resize(100,20)
		...
		self.trainingCheck.resize(150,20)
