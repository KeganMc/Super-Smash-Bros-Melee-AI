...
class SmashGui(QMainWindow):
	...
	def initializePlayerSelection(self):
		...
		self.playerOneSelection.resize(75,20)
		...
		self.playerTwoSelection.resize(75,20)
		...
		self.playerThreeSelection.resize(75,20)
		...
		self.playerFourSelection.resize(75,20)
		...
		self.trainingCheck.resize(100,20)
